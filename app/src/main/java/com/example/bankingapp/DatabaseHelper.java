...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
       ...
       db.execSQL(sql_tr);
       //to insert data
        insertData("Aakash Gupta","aakash@gmail.com",5000,"9255572698","XXXXXXXXXXXX4735",db);
        insertData("Chirag Bhagat","chiragb@gmail.com",15000,"802339459","XXXXXXXXXXXX1344",db);
        insertData("Amithesh Gupta","amitheshg@gmail.com",25000,"2225137174 ","XXXXXXXXXXXX3234",db);
        insertData("Yash Gupta","yashg@gmail.com",56000,"2228073554","XXXXXXXXXXXX1284",db);
        insertData("Ayush Ahuja","ayusha@gmail.com",54000,"9257472698","XXXXXXXXXXXX1534",db);
        insertData("Ranjan Gupta","ranjang@gmail.com",30000,"9834572698","XXXXXXXXXXXX1294",db);
        insertData("Ravi Gupta","ravig@gmail.com",70000,"999972698","XXXXXXXXXXXX1034",db);
        insertData("Vikas Gond","vikasg@gmail.com",85000,"925559876","XXXXXXXXXXXX4234",db);
        insertData("Shlok Kadam","shlokk@gmail.com",25000,"9255234568","XXXXXXXXXXXX1534",db);
        insertData("Rithik Bohra","rithikb@gmail.com",45000,"9234567698","XXXXXXXXXXXX8734",db);
